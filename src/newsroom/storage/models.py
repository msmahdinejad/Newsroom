...
class NormalizedItem(Base):
    ...
    duplicate_of_id: Mapped[Optional[int]] = mapped_column(ForeignKey("normalized_items.id"), nullable=True)
    ...
    duplicate_of: Mapped[Optional["NormalizedItem"]] = relationship(remote_side=[id])
